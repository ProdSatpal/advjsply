                ...
                <TabsContent value="appointment">
                  <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div className="text-center py-8">
                      ...
                      >
                        <a href="https://wa.me/918857972717?text=I%20need%20your%20legal%20assistance%20on%20below%20matter%0A" target="_blank" rel="noopener noreferrer">
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <Button 
            asChild
            variant="gold"
            className="inline-flex items-center px-6 py-3 rounded-md text-navy font-medium transition-colors"
          >
            <a 
